  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        {prefix && (
          <div className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm font-mono font-semibold pointer-events-none">
            {prefix}
          </div>
        )}
        <input
          ...
          id={id}
          className={cn(
            'w-full bg-white border rounded-xl text-slate-900 placeholder:text-slate-400',
