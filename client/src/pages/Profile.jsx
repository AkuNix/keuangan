...
export default function Profile({ user, onLogout, onUserUpdate, onNavigate }) {
    ...
    <div className="max-w-3xl mx-auto">
      ...
      >
        ...
        <div className="relative flex flex-col sm:flex-row items-center gap-6">
          <motion.div
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center flex-shrink-0 shadow-lg shadow-indigo-500/30"
          ...
          <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-bold text-slate-900 dark:text-white text-sm">Edit Profil</h2>
          ...
          <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-bold text-slate-900 dark:text-white text-sm">Info Akun</h2>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Detail akunmu</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center justify-between py-2 border-b border-slate-100 dark:border-slate-700/50">
                <span className="text-sm text-slate-500 dark:text-slate-400">Nama</span>
              ...
              <div className="flex items-center justify-between py-2">
                <span className="text-sm text-slate-500 dark:text-slate-400">Terdaftar</span>
